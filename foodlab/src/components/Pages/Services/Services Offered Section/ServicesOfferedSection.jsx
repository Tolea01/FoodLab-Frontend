      ...
      <Row className='m-0'>
        <Col className='services-offered-col position-relative'>
          ...
          <Row className='w-100'>
            ...
            {servicesOfferedCard(2, 'Various Menu', dishImg)}
            {servicesOfferedCard(3, 'Discount Voucher', discountVoucherImg)}
            {servicesOfferedCard(4, 'Night Party', ladiesNightImg)}
          </Row>
          <Row className='w-100 mt-2'>
            {servicesOfferedCard(5, 'Charity Events', balloonImg)}
            {servicesOfferedCard(6, 'Private Dinning', dinningTableImg)}
            {servicesOfferedCard(7, 'Events Party', barrierImg)}
            {servicesOfferedCard(8, 'Birthday Party', birthdayCakeImg)}
          </Row>
        </Col>
      </Row>
    </section >
